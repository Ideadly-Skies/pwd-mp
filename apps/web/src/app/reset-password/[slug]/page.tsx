...
const resetPasswordSchema = Yup.object().shape({
    password: Yup.string().min(8, 'Password harus memiliki minimal 8 karakter').required('Password cannot be blank'),
    confirmPassword: Yup.string().oneOf([Yup.ref('password'), ''], 'Confirm password harus sama dengan password').required('Confirm your password')
})
