    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <Card className="w-full max-w-md">
        ...
        <div className="flex justify-center">
          ...
          <CardTitle className="text-2xl font-bold py-5 text-center">Verify Your Account</CardTitle>
          <CardDescription>Click the button below to verify your account</CardDescription>
        </CardHeader>
        <CardContent className="">
          <p className="text-sm text-gray-500">
            One step ahead to be a Verified User, Click the button below to Proceed with the Account Verification
          </p>
        </CardContent>
